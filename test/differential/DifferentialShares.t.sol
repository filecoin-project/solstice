...
//
// FilecoinPayVolume is a single USD total (FIPs#1275): the band differential (bandCases) no longer
// applies and the aggregation differential (aggCases) collapses to a simple sum, so both are
// replaced by a few hand-written aggregation cases below. The largest-remainder share differential
// is kept.
